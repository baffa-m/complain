<x-app-layout>
    ...
    <form class="col-span-4 md:col-span-3 mt-10 mx-auto py-5 w-full" style="max-width:700px" method="POST" action="{{ route('add.student') }}">
        ...
        <div class="mt-8 flex justify-between flex-col">
            ...
            <input type="text" name="matric_number" placeholder="Matric Number" class="w-full rounded-lg p-4 bg-gray-50 focus:outline-none text-lg text-gray-700 border-gray-200 placeholder:text-gray-400">
        </div>
